...
<details>
<summary> update node/npm dependencies [Will Boyce] </summary>
...
* update prometheus metrics agents (node exporter, process exporter) [Will Boyce]
* update haproxy to v2.2 [Will Boyce]
* convert more promise chains to async/await [Will Boyce]
